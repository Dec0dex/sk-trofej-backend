...
import rs.netcast.netcat.domain.dto.AuthenticationDto
import rs.netcast.netcat.domain.dto.TokenDto
...
class UserAuthenticationFilter(authenticationManager: AuthenticationManager) : UsernamePasswordAuthenticationFilter() {
    ...
    override fun successfulAuthentication(
        ...
        val user = authentication.principal as NetCatUserPrincipal
